		...
		<div class="col-lg-12">
			<div class="row">
				<div class="form-group">
					...
					<textarea name="progress" id="progress" cols="30" rows="10" class="summernote form-control"
						required=""><?php echo isset($progress) ? $progress : '' ?></textarea>
				</div>
...
<script>
	...
	$('#manage-progress').submit(function (e) {
		...
		$.ajax({
			url: '../api/ajax.php?action=save_progress',
